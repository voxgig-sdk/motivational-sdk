// Command Motivational-mcp is an MCP server exposing the Motivational
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Motivational_list  — list records of an entity
//	Motivational_load  — load a single record of an entity
//
