...
type Args struct {
	Entity string         `json:"entity" jsonschema:"language"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MotivationalSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "motivational_list",
		Description: "List records from Motivational. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "motivational_load",
		Description: "Load a single record from Motivational. " +
...
func runOp(client *sdk.MotivationalSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MotivationalSDK, name string) (sdk.MotivationalEntity, error) {
