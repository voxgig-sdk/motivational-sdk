...
function runner.env_override(m)
  local live = runner.getenv("MOTIVATIONAL_TEST_LIVE")
  local override = runner.getenv("MOTIVATIONAL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MOTIVATIONAL_TEST_EXPLAIN")
