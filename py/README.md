# Motivational Python SDK



The Python SDK for the Motivational API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Language()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/motivational-sdk/releases)) or
...
client = MotivationalSDK(options)
```
...
```
py/
├── motivational_sdk.py         -- Main SDK module
