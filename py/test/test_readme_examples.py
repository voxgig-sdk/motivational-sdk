# Motivational SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MotivationalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MotivationalSDK(...) and MotivationalSDK.test(...) become
#      MotivationalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "motivational_sdk"
_SDK_CLASS = "MotivationalSDK"
