...
from motivational_sdk.core.helpers import get_ctx_prop, to_map
...
class MotivationalContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MotivationalSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MotivationalResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MotivationalResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MotivationalError(code, msg, self)
