...
from motivational_sdk.utility import register

# Load features
from motivational_sdk.feature.base_feature import MotivationalBaseFeature
from motivational_sdk.features import _has_feature, _make_feature
...
class MotivationalSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MotivationalUtility()
        self._utility = utility

        from motivational_sdk.config import shared_config
    ...
    def get_utility(self):
        return MotivationalUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MotivationalSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Language(self, data=None) -> "LanguageEntity":
        ...
        from motivational_sdk.entity.language_entity import LanguageEntity
        return LanguageEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MotivationalSDK":
        if sdkopts is None:
            sdkopts = {}
