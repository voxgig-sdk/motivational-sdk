...
from motivational_sdk.motivational_types import (
    Language,
    LanguageListMatch,
)
...
class LanguageEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Language]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Language().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
