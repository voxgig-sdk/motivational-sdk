...
func registerSDKWords(r *eng.Registry, client *sdk.MotivationalSDK) {
...
func runOp(client *sdk.MotivationalSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
