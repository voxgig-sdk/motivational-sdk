...
// Motivational SDK netsim feature
...
class MotivationalNetsimFeature extends MotivationalBaseFeature
{
    ...
    private function _simulate(MotivationalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MotivationalContext $ctx, array $applied): void
    {
        $client = $this->client;
