...
// Motivational SDK audit feature
...
class MotivationalAuditFeature extends MotivationalBaseFeature
{
    ...
    private function _emit(MotivationalContext $ctx, string $outcome): void
    {
