...
// Motivational SDK clienttrack feature
...
class MotivationalClienttrackFeature extends MotivationalBaseFeature
{
    ...
    public function PostConstruct(MotivationalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Motivational-SDK';
