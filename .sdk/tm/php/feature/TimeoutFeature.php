...
// Motivational SDK timeout feature
...
class MotivationalTimeoutFeature extends MotivationalBaseFeature
{
    ...
    private function _with_timeout(MotivationalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MotivationalContext $_ctx, float $ms): void
    {
        $client = $this->client;
