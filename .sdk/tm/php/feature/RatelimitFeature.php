...
// Motivational SDK ratelimit feature
...
class MotivationalRatelimitFeature extends MotivationalBaseFeature
{
    ...
    private function _acquire(MotivationalContext $ctx): void
    {
    ...
    private function _track(MotivationalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
