...
// Motivational SDK proxy feature
...
class MotivationalProxyFeature extends MotivationalBaseFeature
{
    ...
    public function init(MotivationalContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MotivationalContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
