...
// Motivational SDK streaming feature
...
class MotivationalStreamingFeature extends MotivationalBaseFeature
{
    ...
    private function _iterate(MotivationalResult $result): \Generator
    {
    ...
    private function _streamable(MotivationalContext $ctx): bool
    {
