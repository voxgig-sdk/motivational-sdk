...
// Motivational SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MotivationalTransformResponse
{
    public static function call(MotivationalContext $ctx): mixed
    {
        ...
        $transform = MotivationalHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
