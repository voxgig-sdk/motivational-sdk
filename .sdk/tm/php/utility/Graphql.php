...
// Motivational SDK utility: graphql
//
...
class MotivationalGraphql
{
    ...
    // equivalent.
    public static function body(MotivationalContext $ctx): mixed
    {
    ...
    public static function errors(MotivationalContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
