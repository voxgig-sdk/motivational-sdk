...
// Motivational SDK utility: fetcher

class MotivationalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MotivationalSDK/1.0)';
    ...
    public static function call(MotivationalContext $ctx, string $fullurl, array $fetchdef): array
    {
