...
|---|---|---|
| `ts/` | @voxgig-sdk/motivational-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/motivational-sdk \
      --repository voxgig-sdk/motivational-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/motivational-sdk` shows it, and
`npm trust revoke @voxgig-sdk/motivational-sdk --id=<id>` removes it.
