...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/motivational` | `npm install @voxgig-sdk/motivational` |
| Python | `voxgig-sdk-motivational` | `pip install voxgig-sdk-motivational` |
| PHP | `voxgig-sdk/motivational` | `composer require voxgig-sdk/motivational` |
| Golang | `github.com/voxgig-sdk/motivational-sdk/go` | `go get github.com/voxgig-sdk/motivational-sdk/go` |
| Ruby | `voxgig-sdk-motivational` | `gem install voxgig-sdk-motivational` |
| Lua | `voxgig-sdk-motivational` | `luarocks install voxgig-sdk-motivational` |
