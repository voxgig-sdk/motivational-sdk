...
// Motivational SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MotivationalMakeRequest
{
    public static function call(MotivationalContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MotivationalResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MotivationalResponse($fetched);
        } else {
