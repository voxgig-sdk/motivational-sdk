...
class MotivationalTestRunner
{
    ...
    {
        $live = self::getenv('MOTIVATIONAL_TEST_LIVE');
        $override = self::getenv('MOTIVATIONAL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MOTIVATIONAL_TEST_EXPLAIN');
...
class_alias('MotivationalTestRunner', 'Runner');
class_alias('MotivationalHelpers', 'Helpers');
