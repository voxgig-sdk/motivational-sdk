...
// Motivational SDK pipeline test
//
...
require_once __DIR__ . '/../motivational_sdk.php';
...
{
    private static function utility(): MotivationalUtility
    {
        return new MotivationalUtility();
    }
    ...
    private static function ctx(array $over = []): MotivationalContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MotivationalContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MotivationalOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MotivationalError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MotivationalOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MotivationalMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MotivationalOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MotivationalMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MotivationalOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MotivationalMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MotivationalSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MotivationalMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MotivationalResponse([]),
            'result' => new MotivationalResult([]),
        ]);
        [, $err] = MotivationalMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MotivationalSpec([]),
            'response' => null,
            'result' => new MotivationalResult([]),
        ]);
        [, $err] = MotivationalMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MotivationalSpec(['step' => 's']),
            'response' => new MotivationalResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MotivationalResult([]),
        ]);
        [, $err] = MotivationalMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MotivationalSpec(['step' => 's']),
            'response' => new MotivationalResponse(self::resp(200, ['v' => 1])),
            'result' => new MotivationalResult([]),
        ]);
        [, $err] = MotivationalMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MotivationalSpec(['step' => 's']),
            'response' => new MotivationalResponse(self::resp(200, ['v' => 2])),
            'result' => new MotivationalResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MotivationalMakeResponse::call($ctx);
    ...
    {
        $preset = new MotivationalResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MotivationalSpec([]),
            'response' => new MotivationalResponse([]),
            'result' => new MotivationalResult([]),
        ...
        [$got, $err] = MotivationalMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MotivationalResult([])]);
        [, $err] = MotivationalMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MotivationalSpec([]), 'result' => null]);
        [, $err] = MotivationalMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MotivationalSpec(['step' => 's']),
            'result' => new MotivationalResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MotivationalOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MotivationalMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MotivationalSpec(['step' => 's']),
            'result' => new MotivationalResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MotivationalOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MotivationalMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MotivationalResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MotivationalSpec([]),
            'result' => new MotivationalResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MotivationalMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MotivationalMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MotivationalError('boom', 'boom');
        $utility->fetcher = function (MotivationalContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MotivationalSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MotivationalMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MotivationalContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MotivationalMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MotivationalResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MotivationalMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MotivationalContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MotivationalSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MotivationalMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MotivationalResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MotivationalSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MotivationalMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MotivationalMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MotivationalMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MotivationalResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MotivationalDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MotivationalResult(['ok' => false])]);
        $this->expectException(MotivationalError::class);
        MotivationalDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MotivationalResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MotivationalMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MotivationalMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MotivationalBaseFeature();
        $b = new MotivationalBaseFeature();
        MotivationalFeatureAdd::call($ctx, $a);
        MotivationalFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MotivationalBaseFeature
    {
        $f = new MotivationalBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MotivationalFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MotivationalContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MotivationalSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MotivationalPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MotivationalPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MotivationalResponse(['headers' => null]),
            'result' => new MotivationalResult([]),
        ]);
        MotivationalResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MotivationalResultBody::call($ctx);
