...
// Motivational SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MotivationalSDK::test)
...
{
    private const SDK_CLASS = 'MotivationalSDK';
    ...
    private const SDK_BASE = 'motivational_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../motivational_sdk.php';
