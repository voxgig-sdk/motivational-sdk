...
// Motivational SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MotivationalOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MotivationalOmni::structfix($now, Struct::undef()))
                        !== json_encode(MotivationalOmni::structfix($val, Struct::undef()))) {
