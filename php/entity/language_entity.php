...
// Motivational SDK Language entity
...
class LanguageEntity
{
    ...
    {
        if ($args) {
            $this->_data = MotivationalHelpers::to_map(Struct::clone($args)) ?? [];
    ...
    {
        if ($args) {
            $this->_match = MotivationalHelpers::to_map(Struct::clone($args)) ?? [];
     ...
     *
     * @param LanguageListMatch|array|null $reqmatch Match filter (any subset
     *   of Language fields) as an assoc-array; LanguageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Language[]|array A list of Language items as assoc-arrays at
     *   the SDK boundary; throws MotivationalError on failure (item-5 convention).
     */
