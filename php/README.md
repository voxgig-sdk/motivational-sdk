# Motivational PHP SDK



The PHP SDK for the Motivational API — an entity-oriented client using PHP conventions.
...
```php
require_once 'motivational_sdk.php';
$client = new MotivationalSDK($options);
```
...
```
php/
├── motivational_sdk.php          -- Main SDK class
...
The main class (`motivational_sdk.php`) exports the SDK class
