# Motivational PHP SDK Reference

Complete API reference for the Motivational PHP SDK.
...
#### `MotivationalSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): MotivationalUtility`
