...
// Motivational SDK telemetry feature
...
class MotivationalTelemetryFeature extends MotivationalBaseFeature
{
    ...
    private function _close(MotivationalContext $ctx, bool $ok): void
    {
