...
// Motivational SDK debug feature
...
class MotivationalDebugFeature extends MotivationalBaseFeature
{
    ...
    private function _finish(MotivationalContext $ctx, bool $ok): void
    {
