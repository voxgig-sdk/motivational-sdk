...
// Motivational SDK idempotency feature
...
class MotivationalIdempotencyFeature extends MotivationalBaseFeature
{
    ...
    private function _mutating(MotivationalContext $ctx): bool
    {
