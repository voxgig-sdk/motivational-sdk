...
// Motivational SDK cache feature
...
class MotivationalCacheFeature extends MotivationalBaseFeature
{
    ...
    private function _through(MotivationalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
