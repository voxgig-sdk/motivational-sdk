...
class MotivationalRbacFeature extends MotivationalBaseFeature
{
    ...
    private function _required(MotivationalContext $ctx): ?string
    {
    ...
    private function _reject(MotivationalContext $ctx, string $required): void
    {
    ...
    private function _track(MotivationalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
