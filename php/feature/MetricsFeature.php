...
// Motivational SDK metrics feature
...
class MotivationalMetricsFeature extends MotivationalBaseFeature
{
    ...
    private function _record(MotivationalContext $ctx, bool $ok): void
    {
