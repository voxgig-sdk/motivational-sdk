...
// Motivational SDK utility type

class MotivationalUtility
{
    ...
    public static function copy(MotivationalUtility $src): MotivationalUtility
    {
        $u = new MotivationalUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
