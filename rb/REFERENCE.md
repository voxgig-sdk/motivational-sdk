# Motivational Ruby SDK Reference

Complete API reference for the Motivational Ruby SDK.
...
#### `MotivationalSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Language.list(nil)
```
