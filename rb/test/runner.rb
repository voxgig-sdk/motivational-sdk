...
module MotivationalTestRunner
  ...
  def self.env_override(m)
    live = getenv("MOTIVATIONAL_TEST_LIVE")
    override = getenv("MOTIVATIONAL_TEST_OVERRIDE")
    ...
    explain = getenv("MOTIVATIONAL_TEST_EXPLAIN")
    m["MOTIVATIONAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MotivationalTestRunner
Helpers = MotivationalHelpers
Vs = VoxgigStruct
