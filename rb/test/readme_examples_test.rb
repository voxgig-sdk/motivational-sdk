...
#      offline in seeded test mode (MotivationalSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Motivational_sdk.rb")
  SDK_CLASS = "MotivationalSDK"
