...
function envOverride(m) {
    if ('TRUE' === process.env.MOTIVATIONAL_TEST_LIVE ||
        'TRUE' === process.env.MOTIVATIONAL_TEST_OVERRIDE) {
    ...
    m.MOTIVATIONAL_TEST_EXPLAIN = process.env.MOTIVATIONAL_TEST_EXPLAIN || m.MOTIVATIONAL_TEST_EXPLAIN;
    return m;
}
