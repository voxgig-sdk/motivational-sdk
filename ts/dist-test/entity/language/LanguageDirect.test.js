...
(0, node_test_1.describe)('LanguageDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when MOTIVATIONAL_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('MOTIVATIONAL_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MotivationalSDK({
    ...
    (0, node_test_1.test)('direct-list-language', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-language', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["language01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MotivationalSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['MOTIVATIONAL_TEST_LANGUAGE_ENTID'];
    ...
    const client = new __1.MotivationalSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LanguageDirect.test.js.map