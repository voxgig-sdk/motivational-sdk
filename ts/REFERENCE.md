# Motivational TypeScript SDK Reference

Complete API reference for the Motivational TypeScript SDK.
...
```ts
new MotivationalSDK(options?: object)
```
...
#### `MotivationalSDK.test(testopts?, sdkopts?)`
...
**Returns:** `MotivationalSDK` instance in test mode.
...
Alias for `MotivationalSDK.test()`.
...
Return the parent `MotivationalSDK` instance.
