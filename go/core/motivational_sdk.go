...
func (sdk *MotivationalSDK) OptionsMap() map[string]any {
...
func (sdk *MotivationalSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MotivationalSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MotivationalSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MotivationalSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MotivationalSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MotivationalSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MotivationalSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MotivationalSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MotivationalSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MotivationalSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MotivationalSDK {
	...
	sdk := NewMotivationalSDK(sdkopts)
	sdk.Mode = "test"
