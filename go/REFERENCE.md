# Motivational Golang SDK Reference

Complete API reference for the Motivational Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *MotivationalSDK`
...
#### `Language(data map[string]any) MotivationalEntity`
